...
class settings:
  ...
  def __init__(self):
    ...
    self.imgPath = "/home/neil/AnnotationPrograms/"
    ...
    self.groundTruthTextFolder = self.imgPath + "GTTXT/"
  ...
  def loadImage(self,imgPath):
    ...
    self.polygons = []
    self.polygons.append(polygon(self.color)) # initialize the first polygon
  ...
  def incrementCurrentPoly(self):
    ...
    print "incrementing polygons"
    print("polygons length: " + str(len(s.polygons)))
    self.polygons.append(polygon(self.color))
